...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function sm(){return new Or({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Gf(),fragmentShader:`
		...
		`,blending:ir,depthTest:!1,depthWrite:!1})}function om(){return new Or({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Gf(),fragmentShader:`
	...
	`}function PT(n){let e=new WeakMap,t=null;function i(a){if(a&&a.isTexture){const l=a.mapping,c=l===Qu||l===ef,u=l===Bs||l===Hs;if(c||u)if(a.isRenderTargetTexture&&a.needsPMREMUpdate===!0){a.needsPMREMUpdate=!1;let d=e.get(a);return t===null&&(t=new im(n)),d=c?t.fromEquirectangular(a,d):t.fromCubemap(a,d),e.set(a,d),d.texture}else{if(e.has(a))return e.get(a).texture;{const d=a.image;if(c&&d&&d.height>0||u&&d&&r(d)){t===null&&(t=new im(n));const h=c?t.fromEquirectangular(a):t.fromCubemap(a);return e.set(a,h),a.addEventListener("dispose",s),h.texture}else return null}}}return a}function r(a){let l=0;const c=6;for(let u=0;u<c;u++)a[u]!==void 0&&l++;return l===c}function s(a){const l=a.target;l.removeEventListener("dispose",s);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function o(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:i,dispose:o}}function IT(n){const e={};function t(i){if(e[i]!==void 0)return e[i];let r;switch(i){case"WEBGL_depth_texture":r=n.getExtension("WEBGL_depth_texture")||n.getExtension("MOZ_WEBGL_depth_texture")||n.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":r=n.getExtension("EXT_texture_filter_anisotropic")||n.getExtension("MOZ_EXT_texture_filter_anisotropic")||n.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":r=n.getExtension("WEBGL_compressed_texture_s3tc")||n.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":r=n.getExtension("WEBGL_compressed_texture_pvrtc")||n.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:r=n.getExtension(i)}return e[i]=r,r}return{has:function(i){return t(i)!==null},init:function(i){i.isWebGL2?t("EXT_color_buffer_float"):(t("WEBGL_depth_texture"),t("OES_texture_float"),t("OES_texture_half_float"),t("OES_texture_half_float_linear"),t("OES_standard_derivatives"),t("OES_element_index_uint"),t("OES_vertex_array_object"),t("ANGLE_instanced_arrays")),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture")},get:function(i){const r=t(i);return r===null&&console.warn("THREE.WebGLRenderer: "+i+" extension not supported."),r}}}function DT(n,e,t,i){const r={},s=new WeakMap;function o(d){const h=d.target;h.index!==null&&e.remove(h.index);for(const v in h.attributes)e.remove(h.attributes[v]);for(const v in h.morphAttributes){const x=h.morphAttributes[v];for(let p=0,g=x.length;p<g;p++)e.remove(x[p])}h.removeEventListener("dispose",o),delete r[h.id];const m=s.get(h);m&&(e.remove(m),s.delete(h)),i.releaseStatesOfGeometry(h),h.isInstancedBufferGeometry===!0&&delete h._maxInstanceCount,t.memory.geometries--}function a(d,h){return r[h.id]===!0||(h.addEventListener("dispose",o),r[h.id]=!0,t.memory.geometries++),h}function l(d){const h=d.attributes;for(const v in h)e.update(h[v],n.ARRAY_BUFFER);const m=d.morphAttributes;for(const v in m){const x=m[v];for(let p=0,g=x.length;p<g;p++)e.update(x[p],n.ARRAY_BUFFER)}}function c(d){const h=[],m=d.index,v=d.attributes.position;let x=0;if(m!==null){const b=m.array;x=m.version;for(let E=0,A=b.length;E<A;E+=3){const C=b[E+0],B=b[E+1],D=b[E+2];h.push(C,B,B,D,D,C)}}else if(v!==void 0){const b=v.array;x=v.version;for(let E=0,A=b.length/3-1;E<A;E+=3){const C=E+0,B=E+1,D=E+2;h.push(C,B,B,D,D,C)}}else return;const p=new(T_(h)?I_:P_)(h,1);p.version=x;const g=s.get(d);g&&e.remove(g),s.set(d,p)}function u(d){const h=s.get(d);if(h){const m=d.index;m!==null&&h.version<m.version&&c(d)}else c(d);return s.get(d)}return{get:a,update:l,getWireframeAttribute:u}}function NT(n,e,t,i){const r=i.isWebGL2;let s;function o(h){s=h}let a,l;function c(h){a=h.type,l=h.bytesPerElement}function u(h,m){n.drawElements(s,m,a,h*l),t.update(m,s,1)}function d(h,m,v){if(v===0)return;let x,p;if(r)x=n,p="drawElementsInstanced";else if(x=e.get("ANGLE_instanced_arrays"),p="drawElementsInstancedANGLE",x===null){console.error("THREE.WebGLIndexedBufferRenderer: using THREE.InstancedBufferGeometry but hardware does not support extension ANGLE_instanced_arrays.");return}x[p](s,m,a,h*l,v),t.update(m,s,v)}this.setMode=o,this.setIndex=c,this.render=u,this.renderInstances=d}function UT(n){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function i(s,o,a){switch(t.calls++,o){case n.TRIANGLES:t.triangles+=a*(s/3);break;case n.LINES:t.lines+=a*(s/2);break;case n.LINE_STRIP:t.lines+=a*(s-1);break;case n.LINE_LOOP:t.lines+=a*s;break;case n.POINTS:t.points+=a*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",o);break}}function r(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:r,update:i}}function OT(n,e){return n[0]-e[0]}function FT(n,e){return Math.abs(e[1])-Math.abs(n[1])}function BT(n,e,t){const i={},r=new Float32Array(8),s=new WeakMap,o=new At,a=[];for(let c=0;c<8;c++)a[c]=[c,0];function l(c,u,d){const h=c.morphTargetInfluences;if(e.isWebGL2===!0){const v=u.morphAttributes.position||u.morphAttributes.normal||u.morphAttributes.color,x=v!==void 0?v.length:0;let p=s.get(u);if(p===void 0||p.count!==x){let Z=function(){Ee.dispose(),s.delete(u),u.removeEventListener("dispose",Z)};var m=Z;p!==void 0&&p.texture.dispose();const E=u.morphAttributes.position!==void 0,A=u.morphAttributes.normal!==void 0,C=u.morphAttributes.color!==void 0,B=u.morphAttributes.position||[],D=u.morphAttributes.normal||[],ie=u.morphAttributes.color||[];let R=0;E===!0&&(R=1),A===!0&&(R=2),C===!0&&(R=3);let N=u.attributes.position.count*R,de=1;N>e.maxTextureSize&&(de=Math.ceil(N/e.maxTextureSize),N=e.maxTextureSize);const Me=new Float32Array(N*de*4*x),Ee=new R_(Me,N,de,x);Ee.type=wi,Ee.needsUpdate=!0;const H=R*4;for(let ce=0;ce<x;ce++){const ee=B[ce],pe=D[ce],ye=ie[ce],xe=N*de*4*ce;for(let z=0;z<ee.count;z++){const Q=z*H;E===!0&&(o.fromBufferAttribute(ee,z),Me[xe+Q+0]=o.x,Me[xe+Q+1]=o.y,Me[xe+Q+2]=o.z,Me[xe+Q+3]=0),A===!0&&(o.fromBufferAttribute(pe,z),Me[xe+Q+4]=o.x,Me[xe+Q+5]=o.y,Me[xe+Q+6]=o.z,Me[xe+Q+7]=0),C===!0&&(o.fromBufferAttribute(ye,z),Me[xe+Q+8]=o.x,Me[xe+Q+9]=o.y,Me[xe+Q+10]=o.z,Me[xe+Q+11]=ye.itemSize===4?o.w:1)}}p={count:x,texture:Ee,size:new rt(N,de)},s.set(u,p),u.addEventListener("dispose",Z)}let g=0;for(let E=0;E<h.length;E++)g+=h[E];const b=u.morphTargetsRelative?1:1-g;d.getUniforms().setValue(n,"morphTargetBaseInfluence",b),d.getUniforms().setValue(n,"morphTargetInfluences",h),d.getUniforms().setValue(n,"morphTargetsTexture",p.texture,t),d.getUniforms().setValue(n,"morphTargetsTextureSize",p.size)}else{const v=h===void 0?0:h.length;let x=i[u.id];if(x===void 0||x.length!==v){x=[];for(let A=0;A<v;A++)x[A]=[A,0];i[u.id]=x}for(let A=0;A<v;A++){const C=x[A];C[0]=A,C[1]=h[A]}x.sort(FT);for(let A=0;A<8;A++)A<v&&x[A][1]?(a[A][0]=x[A][0],a[A][1]=x[A][1]):(a[A][0]=Number.MAX_SAFE_INTEGER,a[A][1]=0);a.sort(OT);const p=u.morphAttributes.position,g=u.morphAttributes.normal;let b=0;for(let A=0;A<8;A++){const C=a[A],B=C[0],D=C[1];B!==Number.MAX_SAFE_INTEGER&&D?(p&&u.getAttribute("morphTarget"+A)!==p[B]&&u.setAttribute("morphTarget"+A,p[B]),g&&u.getAttribute("morphNormal"+A)!==g[B]&&u.setAttribute("morphNormal"+A,g[B]),r[A]=D,b+=D):(p&&u.hasAttribute("morphTarget"+A)===!0&&u.deleteAttribute("morphTarget"+A),g&&u.hasAttribute("morphNormal"+A)===!0&&u.deleteAttribute("morphNormal"+A),r[A]=0)}const E=u.morphTargetsRelative?1:1-b;d.getUniforms().setValue(n,"morphTargetBaseInfluence",E),d.getUniforms().setValue(n,"morphTargetInfluences",r)}}return{update:l}}function HT(n,e,t,i){let r=new WeakMap;function s(l){const c=i.render.frame,u=l.geometry,d=e.get(l,u);if(r.get(d)!==c&&(e.update(d),r.set(d,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",a)===!1&&l.addEventListener("dispose",a),r.get(l)!==c&&(t.update(l.instanceMatrix,n.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,n.ARRAY_BUFFER),r.set(l,c))),l.isSkinnedMesh){const h=l.skeleton;r.get(h)!==c&&(h.update(),r.set(h,c))}return d}function o(){r=new WeakMap}function a(l){const c=l.target;c.removeEventListener("dispose",a),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:s,dispose:o}}const F_=new sn,B_=new R_,H_=new TM,k_=new U_,am=[],lm=[],cm=new Float32Array(16),um=new Float32Array(9),fm=new Float32Array(4);function Zs(n,e,t){const i=n[0];if(i<=0||i>0)return n;const r=e*t;let s=am[r];if(s===void 0&&(s=new Float32Array(r),am[r]=s),e!==0){i.toArray(s,0);for(let o=1,a=0;o!==e;++o)a+=t,n[o].toArray(s,a)}return s}function jt(n,e){if(n.length!==e.length)return!1;for(let t=0,i=n.length;t<i;t++)if(n[t]!==e[t])return!1;return!0}function qt(n,e){for(let t=0,i=e.length;t<i;t++)n[t]=e[t]}function Wl(n,e){let t=lm[e];t===void 0&&(t=new Int32Array(e),lm[e]=t);for(let i=0;i!==e;++i)t[i]=n.allocateTextureUnit();return t}function kT(n,e){const t=this.cache;t[0]!==e&&(n.uniform1f(this.addr,e),t[0]=e)}function zT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(jt(t,e))return;n.uniform2fv(this.addr,e),qt(t,e)}}function VT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(n.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(jt(t,e))return;n.uniform3fv(this.addr,e),qt(t,e)}}function GT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(jt(t,e))return;n.uniform4fv(this.addr,e),qt(t,e)}}function WT(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(jt(t,e))return;n.uniformMatrix2fv(this.addr,!1,e),qt(t,e)}else{if(jt(t,i))return;fm.set(i),n.uniformMatrix2fv(this.addr,!1,fm),qt(t,i)}}function XT(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(jt(t,e))return;n.uniformMatrix3fv(this.addr,!1,e),qt(t,e)}else{if(jt(t,i))return;um.set(i),n.uniformMatrix3fv(this.addr,!1,um),qt(t,i)}}function jT(n,e){const t=this.cache,i=e.elements;if(i===void 0){if(jt(t,e))return;n.uniformMatrix4fv(this.addr,!1,e),qt(t,e)}else{if(jt(t,i))return;cm.set(i),n.uniformMatrix4fv(this.addr,!1,cm),qt(t,i)}}function qT(n,e){const t=this.cache;t[0]!==e&&(n.uniform1i(this.addr,e),t[0]=e)}function YT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(jt(t,e))return;n.uniform2iv(this.addr,e),qt(t,e)}}function KT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(jt(t,e))return;n.uniform3iv(this.addr,e),qt(t,e)}}function $T(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(jt(t,e))return;n.uniform4iv(this.addr,e),qt(t,e)}}function ZT(n,e){const t=this.cache;t[0]!==e&&(n.uniform1ui(this.addr,e),t[0]=e)}function JT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(n.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(jt(t,e))return;n.uniform2uiv(this.addr,e),qt(t,e)}}function QT(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(n.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(jt(t,e))return;n.uniform3uiv(this.addr,e),qt(t,e)}}function e1(n,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(n.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(jt(t,e))return;n.uniform4uiv(this.addr,e),qt(t,e)}}function t1(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2D(e||F_,r)}function n1(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture3D(e||H_,r)}function i1(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTextureCube(e||k_,r)}function r1(n,e,t){const i=this.cache,r=t.allocateTextureUnit();i[0]!==r&&(n.uniform1i(this.addr,r),i[0]=r),t.setTexture2DArray(e||B_,r)}function s1(n){switch(n){case 5126:return kT;case 35664:return zT;case 35665:return VT;case 35666:return GT;case 35674:return WT;case 35675:return XT;case 35676:return jT;case 5124:case 35670:return qT;case 35667:case 35671:return YT;case 35668:case 35672:return KT;case 35669:case 35673:return $T;case 5125:return ZT;case 36294:return JT;case 36295:return QT;case 36296:return e1;case 35678:case 36198:case 36298:case 36306:case 35682:return t1;case 35679:case 36299:case 36307:return n1;case 35680:case 36300:case 36308:case 36293:return i1;case 36289:case 36303:case 36311:case 36292:return r1}}function o1(n,e){n.uniform1fv(this.addr,e)}function a1(n,e){const t=Zs(e,this.size,2);n.uniform2fv(this.addr,t)}function l1(n,e){const t=Zs(e,this.size,3);n.uniform3fv(this.addr,t)}function c1(n,e){const t=Zs(e,this.size,4);n.uniform4fv(this.addr,t)}function u1(n,e){const t=Zs(e,this.size,4);n.uniformMatrix2fv(this.addr,!1,t)}function f1(n,e){const t=Zs(e,this.size,9);n.uniformMatrix3fv(this.addr,!1,t)}function h1(n,e){const t=Zs(e,this.size,16);n.uniformMatrix4fv(this.addr,!1,t)}function d1(n,e){n.uniform1iv(this.addr,e)}function p1(n,e){n.uniform2iv(this.addr,e)}function m1(n,e){n.uniform3iv(this.addr,e)}function g1(n,e){n.uniform4iv(this.addr,e)}function _1(n,e){n.uniform1uiv(this.addr,e)}function v1(n,e){n.uniform2uiv(this.addr,e)}function x1(n,e){n.uniform3uiv(this.addr,e)}function S1(n,e){n.uniform4uiv(this.addr,e)}function y1(n,e,t){const i=this.cache,r=e.length,s=Wl(t,r);jt(i,s)||(n.uniform1iv(this.addr,s),qt(i,s));for(let o=0;o!==r;++o)t.setTexture2D(e[o]||F_,s[o])}function M1(n,e,t){const i=this.cache,r=e.length,s=Wl(t,r);jt(i,s)||(n.uniform1iv(this.addr,s),qt(i,s));for(let o=0;o!==r;++o)t.setTexture3D(e[o]||H_,s[o])}function E1(n,e,t){const i=this.cache,r=e.length,s=Wl(t,r);jt(i,s)||(n.uniform1iv(this.addr,s),qt(i,s));for(let o=0;o!==r;++o)t.setTextureCube(e[o]||k_,s[o])}function b1(n,e,t){const i=this.cache,r=e.length,s=Wl(t,r);jt(i,s)||(n.uniform1iv(this.addr,s),qt(i,s));for(let o=0;o!==r;++o)t.setTexture2DArray(e[o]||B_,s[o])}function T1(n){switch(n){case 5126:return o1;case 35664:return a1;case 35665:return l1;case 35666:return c1;case 35674:return u1;case 35675:return f1;case 35676:return h1;case 5124:case 35670:return d1;case 35667:case 35671:return p1;case 35668:case 35672:return m1;case 35669:case 35673:return g1;case 5125:return _1;case 36294:return v1;case 36295:return x1;case 36296:return S1;case 35678:case 36198:case 36298:case 36306:case 35682:return y1;case 35679:case 36299:case 36307:return M1;case 35680:case 36300:case 36308:case 36293:return E1;case 36289:case 36303:case 36311:case 36292:return b1}}class A1{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.setValue=s1(t.type)}}class w1{constructor(e,t,i){this.id=e,this.addr=i,this.cache=[],this.size=t.size,this.setValue=T1(t.type)}}class R1{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,i){const r=this.seq;for(let s=0,o=r.length;s!==o;++s){const a=r[s];a.setValue(e,t[a.id],i)}}}const Au=/(\w+)(\])?(\[|\.)?/g;function hm(n,e){n.seq.push(e),n.map[e.id]=e}function C1(n,e,t){const i=n.name,r=i.length;for(Au.lastIndex=0;;){const s=Au.exec(i),o=Au.lastIndex;let a=s[1];const l=s[2]==="]",c=s[3];if(l&&(a=a|0),c===void 0||c==="["&&o+2===r){hm(t,c===void 0?new A1(a,n,e):new w1(a,n,e));break}else{let d=t.map[a];d===void 0&&(d=new R1(a),hm(t,d)),t=d}}}class dl{constructor(e,t){this.seq=[],this.map={};const i=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let r=0;r<i;++r){const s=e.getActiveUniform(t,r),o=e.getUniformLocation(t,s.name);C1(s,o,this)}}setValue(e,t,i,r){const s=this.map[t];s!==void 0&&s.setValue(e,i,r)}setOptional(e,t,i){const r=t[i];r!==void 0&&this.setValue(e,i,r)}static upload(e,t,i,r){for(let s=0,o=t.length;s!==o;++s){const a=t[s],l=i[a.id];l.needsUpdate!==!1&&a.setValue(e,l.value,r)}}static seqWithValue(e,t){const i=[];for(let r=0,s=e.length;r!==s;++r){const o=e[r];o.id in t&&i.push(o)}return i}}function dm(n,e,t){const i=n.createShader(e);return n.shaderSource(i,t),n.compileShader(i),i}let L1=0;function P1(n,e){const t=n.split(`
`),i=[],r=Math.max(e-6,0),s=Math.min(e+6,t.length);for(let o=r;o<s;o++){const a=o+1;i.push(`${a===e?">":" "} ${a}: ${t[o]}`)}return i.join(`
`)}function I1(n){const e=xt.getPrimaries(xt.workingColorSpace),t=xt.getPrimaries(n);let i;switch(e===t?i="":e===bl&&t===El?i="LinearDisplayP3ToLinearSRGB":e===El&&t===bl&&(i="LinearSRGBToLinearDisplayP3"),n){case on:case Vl:return[i,"LinearTransferOETF"];case kt:case Bf:return[i,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space:",n),[i,"LinearTransferOETF"]}}function pm(n,e,t){const i=n.getShaderParameter(e,n.COMPILE_STATUS),r=n.getShaderInfoLog(e).trim();if(i&&r==="")return"";const s=/ERROR: 0:(\d+)/.exec(r);if(s){const o=parseInt(s[1]);return t.toUpperCase()+`

`+r+`

`+P1(n.getShaderSource(e),o)}else return r}function D1(n,e){const t=I1(e);return`vec4 ${n}( vec4 value ) { return ${t[0]}( ${t[1]}( value ) ); }`}function N1(n,e){let t;switch(e){case Dy:t="Linear";break;case Ny:t="Reinhard";break;case Uy:t="OptimizedCineon";break;case Oy:t="ACESFilmic";break;case Fy:t="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",e),t="Linear"}return"vec3 "+n+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}function U1(n){return[n.extensionDerivatives||n.envMapCubeUVHeight||n.bumpMap||n.normalMapTangentSpace||n.clearcoatNormalMap||n.flatShading||n.shaderID==="physical"?"#extension GL_OES_standard_derivatives : enable":"",(n.extensionFragDepth||n.logarithmicDepthBuffer)&&n.rendererExtensionFragDepth?"#extension GL_EXT_frag_depth : enable":"",n.extensionDrawBuffers&&n.rendererExtensionDrawBuffers?"#extension GL_EXT_draw_buffers : require":"",(n.extensionShaderTextureLOD||n.envMap||n.transmission)&&n.rendererExtensionShaderTextureLod?"#extension GL_EXT_shader_texture_lod : enable":""].filter(Do).join(`
`)}function O1(n){const e=[];for(const t in n){const i=n[t];i!==!1&&e.push("#define "+t+" "+i)}return e.join(`
`)}function F1(n,e){const t={},i=n.getProgramParameter(e,n.ACTIVE_ATTRIBUTES);for(let r=0;r<i;r++){const s=n.getActiveAttrib(e,r),o=s.name;let a=1;s.type===n.FLOAT_MAT2&&(a=2),s.type===n.FLOAT_MAT3&&(a=3),s.type===n.FLOAT_MAT4&&(a=4),t[o]={type:s.type,location:n.getAttribLocation(e,o),locationSize:a}}return t}function Do(n){return n!==""}function mm(n,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return n.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function gm(n,e){return n.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const B1=/^[ \t]*#include +<([\w\d./]+)>/gm;function af(n){return n.replace(B1,k1)}const H1=new Map([["encodings_fragment","colorspace_fragment"],["encodings_pars_fragment","colorspace_pars_fragment"],["output_fragment","opaque_fragment"]]);function k1(n,e){let t=at[e];if(t===void 0){const i=H1.get(e);if(i!==void 0)t=at[i],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,i);else throw new Error("Can not resolve #include <"+e+">")}return af(t)}const z1=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function _m(n){return n.replace(z1,V1)}function V1(n,e,t,i){let r="";for(let s=parseInt(e);s<parseInt(t);s++)r+=i.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return r}function vm(n){let e="precision "+n.precision+` float;
precision `+n.precision+" int;";return n.precision==="highp"?e+=`
#define HIGH_PRECISION`:n.precision==="mediump"?e+=`
#define MEDIUM_PRECISION`:n.precision==="lowp"&&(e+=`
#define LOW_PRECISION`),e}function G1(n){let e="SHADOWMAP_TYPE_BASIC";return n.shadowMapType===l_?e="SHADOWMAP_TYPE_PCF":n.shadowMapType===fy?e="SHADOWMAP_TYPE_PCF_SOFT":n.shadowMapType===Ti&&(e="SHADOWMAP_TYPE_VSM"),e}function W1(n){let e="ENVMAP_TYPE_CUBE";if(n.envMap)switch(n.envMapMode){case Bs:case Hs:e="ENVMAP_TYPE_CUBE";break;case zl:e="ENVMAP_TYPE_CUBE_UV";break}return e}function X1(n){let e="ENVMAP_MODE_REFLECTION";if(n.envMap)switch(n.envMapMode){case Hs:e="ENVMAP_MODE_REFRACTION";break}return e}function j1(n){let e="ENVMAP_BLENDING_NONE";if(n.envMap)switch(n.combine){case f_:e="ENVMAP_BLENDING_MULTIPLY";break;case Py:e="ENVMAP_BLENDING_MIX";break;case Iy:e="ENVMAP_BLENDING_ADD";break}return e}function q1(n){const e=n.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,i=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),7*16)),texelHeight:i,maxMip:t}}function Y1(n,e,t,i){const r=n.getContext(),s=t.defines;let o=t.vertexShader,a=t.fragmentShader;const l=G1(t),c=W1(t),u=X1(t),d=j1(t),h=q1(t),m=t.isWebGL2?"":U1(t),v=O1(s),x=r.createProgram();let p,g,b=t.glslVersion?"#version "+t.glslVersion+`
...
*/var gR=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};function _R(n){return n&&n.__esModule&&Object.prototype.hasOwnProperty.call(n,"default")?n.default:n}var Z_={exports:{}};/*!
* fullPage 4.0.20
...
*
* Copyright (C) 2018 http://alvarotrigo.com/fullPage/ - A project by Alvaro Trigo
*/(function(n,e){(function(t,i){n.exports=i()})(gR,function(){var t,i,r,s;Array.prototype.find||Object.defineProperty(Array.prototype,"find",{value:function(f){if(this==null)throw new TypeError('"this" is null or not defined');var _=Object(this),M=_.length>>>0;if(typeof f!="function")throw new TypeError("predicate must be a function");for(var P=arguments[1],k=0;k<M;){var he=_[k];if(f.call(P,he,k,_))return he;k++}}}),Array.from||(Array.from=(t=Object.prototype.toString,i=function(f){return typeof f=="function"||t.call(f)==="[object Function]"},r=Math.pow(2,53)-1,s=function(f){var _=function(M){var P=Number(M);return isNaN(P)?0:P!==0&&isFinite(P)?(P>0?1:-1)*Math.floor(Math.abs(P)):P}(f);return Math.min(Math.max(_,0),r)},function(f){var _=this,M=Object(f);if(f==null)throw new TypeError("Array.from requires an array-like object - not null or undefined");var P,k=arguments.length>1?arguments[1]:void 0;if(k!==void 0){if(!i(k))throw new TypeError("Array.from: when provided, the second argument must be a function");arguments.length>2&&(P=arguments[2])}for(var he,re=s(M.length),Ve=i(_)?Object(new _(re)):new Array(re),Oe=0;Oe<re;)he=M[Oe],Ve[Oe]=k?P===void 0?k(he,Oe):k.call(P,he,Oe):he,Oe+=1;return Ve.length=re,Ve}));var o=window,a=document,l=navigator.userAgent.match(/(iPhone|iPod|iPad|Android|playbook|silk|BlackBerry|BB10|Windows Phone|Tizen|Bada|webOS|IEMobile|Opera Mini)/),c=/(Mac|iPhone|iPod|iPad)/i.test(o.navigator.userAgent),u="ontouchstart"in o||navigator.msMaxTouchPoints>0||navigator.maxTouchPoints,d=!!window.MSInputMethodContext&&!!document.documentMode,h={test:{},shared:{}};function m(f,_){o.console&&o.console[f]&&o.console[f]("fullPage: "+_)}function v(f){return o.getComputedStyle(f).display!=="none"}function x(f){return Array.from(f).filter(function(_){return v(_)})}function p(f,_){return(_=arguments.length>1?_:document)?_.querySelectorAll(f):null}function g(f){f=f||{};for(var _=1,M=arguments.length;_<M;++_){var P=arguments[_];if(P)for(var k in P)P.hasOwnProperty(k)&&k!="__proto__"&&k!="constructor"&&(Object.prototype.toString.call(P[k])!=="[object Object]"?f[k]=P[k]:f[k]=g(f[k],P[k]))}return f}function b(f,_){return f!=null&&f.classList.contains(_)}function E(){return"innerHeight"in o?o.innerHeight:a.documentElement.offsetHeight}function A(){return o.innerWidth}function C(f,_){var M;for(M in f=N(f),_)if(_.hasOwnProperty(M)&&M!==null)for(var P=0;P<f.length;P++)f[P].style[M]=_[M];return f}function B(f,_){if(!f)return null;if(_==null)return f.previousElementSibling;var M=B(f);return M&&W(M,_)?M:null}function D(f,_){if(!f)return null;if(_==null)return f.nextElementSibling;var M=D(f);return M&&W(M,_)?M:null}function ie(f){return f[f.length-1]}function R(f,_){f=Ee(f)?f[0]:f;for(var M=_!=null?p(_,f.parentNode):f.parentNode.childNodes,P=0,k=0;k<M.length;k++){if(M[k]==f)return P;M[k].nodeType==1&&P++}return-1}function N(f){return Ee(f)?f:[f]}function de(f){f=N(f);for(var _=0;_<f.length;_++)f[_].style.display="none";return f}function Me(f){f=N(f);for(var _=0;_<f.length;_++)f[_].style.display="block";return f}function Ee(f){return Object.prototype.toString.call(f)==="[object Array]"||Object.prototype.toString.call(f)==="[object NodeList]"}function H(f,_){f=N(f);for(var M=0;M<f.length;M++)f[M].classList.add(_);return f}function Z(f,_){f=N(f);for(var M=_.split(" "),P=0;P<M.length;P++){_=M[P];for(var k=0;k<f.length;k++)f[k].classList.remove(_)}return f}function ce(f,_){_.appendChild(f)}function ee(f,_,M){var P;_=_||a.createElement("div");for(var k=0;k<f.length;k++){var he=f[k];(M&&!k||!M)&&(P=_.cloneNode(!0),he.parentNode.insertBefore(P,he)),P.appendChild(he)}return f}function pe(f,_){ee(f,_,!0)}function ye(f,_){for(typeof _=="string"&&(_=se(_)),f.appendChild(_);f.firstChild!==_;)_.appendChild(f.firstChild)}function xe(f){for(var _=a.createDocumentFragment();f.firstChild;)_.appendChild(f.firstChild);f.parentNode.replaceChild(_,f)}function z(f,_){return f&&f.nodeType===1?W(f,_)?f:z(f.parentNode,_):null}function Q(f,_){Pe(f,f.nextSibling,_)}function Re(f,_){Pe(f,f,_)}function Pe(f,_,M){Ee(M)||(typeof M=="string"&&(M=se(M)),M=[M]);for(var P=0;P<M.length;P++)f.parentNode.insertBefore(M[P],_)}function Ne(){var f=a.documentElement;return(o.pageYOffset||f.scrollTop)-(f.clientTop||0)}function He(f){return Array.prototype.filter.call(f.parentNode.children,function(_){return _!==f})}function j(f){f.preventDefault()}function ne(f,_){return f.getAttribute(_)}function ge(f,_,M){a.addEventListener(f,_,M==="undefined"?null:M)}function Le(f,_,M){o.addEventListener(f,_,M==="undefined"?null:M)}function Ie(f,_,M){a.removeEventListener(f,_,M==="undefined"?null:M)}function S(f,_,M){o.removeEventListener(f,_,M==="undefined"?null:M)}function I(f){if(typeof f=="function")return!0;var _=Object.prototype.toString.call(f);return _==="[object Function]"||_==="[object GeneratorFunction]"}function O(f,_,M){var P;M=M===void 0?{}:M,typeof o.CustomEvent=="function"?P=new CustomEvent(_,{detail:M}):(P=a.createEvent("CustomEvent")).initCustomEvent(_,!0,!0,M),f.dispatchEvent(P)}function W(f,_){return(f.matches||f.t||f.msMatchesSelector||f.mozMatchesSelector||f.webkitMatchesSelector||f.oMatchesSelector).call(f,_)}function K(f,_){if(typeof _=="boolean")for(var M=0;M<f.length;M++)f[M].style.display=_?"block":"none";return f}function se(f){var _=a.createElement("div");return _.innerHTML=f.trim(),_.firstChild}function ve(f){f=N(f);for(var _=0;_<f.length;_++){var M=f[_];M&&M.parentElement&&M.parentNode.removeChild(M)}}function oe(f,_){Array.prototype.filter.call(f,_)}function Se(f,_,M){for(var P=f[M],k=[];P;)(W(P,_)||_==null)&&k.push(P),P=P[M];return k}function _e(f,_){return Se(f,_,"nextElementSibling")}function Be(f,_){return Se(f,_,"previousElementSibling")}function w(f){return Object.keys(f).map(function(_){return f[_]})}function y(f){return f[f.length-1]}function G(f,_){for(var M=0,P=f.slice(Math.max(f.length-_,1)),k=0;k<P.length;k++)M+=P[k];return Math.ceil(M/_)}function ue(f,_){f.setAttribute(_,ne(f,"data-"+_)),f.removeAttribute("data-"+_)}function fe(f,_){var M=[f];do f=f.parentNode,M.push(f);while(!W(f,_));return M}function me(){var f=a.activeElement;return W(f,"textarea")||W(f,"input")||W(f,"select")||ne(f,"contentEditable")=="true"||ne(f,"contentEditable")==""}o.NodeList&&!NodeList.prototype.forEach&&(NodeList.prototype.forEach=function(f,_){_=_||window;for(var M=0;M<this.length;M++)f.call(_,this[M],M,this)}),typeof Object.assign!="function"&&Object.defineProperty(Object,"assign",{value:function(f,_){if(f==null)throw new TypeError("Cannot convert undefined or null to object");for(var M=Object(f),P=1;P<arguments.length;P++){var k=arguments[P];if(k!=null)for(var he in k)Object.prototype.hasOwnProperty.call(k,he)&&(M[he]=k[he])}return M},writable:!0,i:!0}),window.fp_utils={$:p,deepExtend:g,hasClass:b,getWindowHeight:E,css:C,prev:B,next:D,last:ie,index:R,getList:N,hide:de,show:Me,isArrayOrList:Ee,addClass:H,removeClass:Z,appendTo:ce,wrap:ee,wrapAll:pe,wrapInner:ye,unwrap:xe,closest:z,after:Q,before:Re,insertBefore:Pe,getScrollTop:Ne,siblings:He,preventDefault:j,isFunction:I,trigger:O,matches:W,toggle:K,createElementFromHTML:se,remove:ve,filter:oe,untilAll:Se,nextAll:_e,prevAll:Be,showError:m};var De=Object.freeze({__proto__:null,showError:m,isVisible:v,getVisible:x,$:p,deepExtend:g,hasClass:b,getWindowHeight:E,o:A,css:C,prev:B,next:D,last:ie,index:R,getList:N,hide:de,show:Me,isArrayOrList:Ee,addClass:H,removeClass:Z,appendTo:ce,wrap:ee,wrapAll:pe,wrapInner:ye,unwrap:xe,closest:z,after:Q,before:Re,insertBefore:Pe,getScrollTop:Ne,siblings:He,preventDefault:j,l:ne,u:ge,v:Le,p:Ie,h:S,isFunction:I,trigger:O,matches:W,toggle:K,createElementFromHTML:se,remove:ve,filter:oe,untilAll:Se,nextAll:_e,prevAll:Be,toArray:w,g:y,S:G,M:ue,T:fe,A:me});function Te(f){return Te=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(_){return typeof _}:function(_){return _&&typeof Symbol=="function"&&_.constructor===Symbol&&_!==Symbol.prototype?"symbol":typeof _},Te(f)}var J={O:{},R:function(f,_){var M=this;return Te(this.O[f])!=="object"&&(this.O[f]=[]),this.O[f].push(_),function(){return M.removeListener(f,_)}},removeListener:function(f,_){if(Te(this.O[f])==="object"){var M=this.O[f].indexOf(_);M>-1&&this.O[f].splice(M,1)}},L:function(f){for(var _=this,M=arguments.length,P=new Array(M>1?M-1:0),k=1;k<M;k++)P[k-1]=arguments[k];Te(this.O[f])==="object"&&this.O[f].forEach(function(he){return he.apply(_,P)})},once:function(f,_){var M=this,P=this.R(f,function(){P();for(var k=arguments.length,he=new Array(k),re=0;re<k;re++)he[re]=arguments[re];_.apply(M,he)})}},T={j:0,D:0,slides:[],N:[],P:null,H:null,C:!1,I:!1,W:!1,F:!1,V:!1,Z:void 0,B:void 0,G:!1,canScroll:!0,Y:"none",U:"none",X:!1,_:!1,J:!0,K:0,q:E(),nn:!1,tn:{}};function Y(f){Object.assign(T,f)}function V(){return T}o.state=T;var Ge="onAfterRenderNoAnchor",ke="onClickOrTouch",je="moveSlideLeft",Xe="moveSlideRight",F="onInitialise",Ae="bindEvents",we="onDestroy",Ue="contentChanged",Ce="onScrollOverflowScrolled",be="onScrollPageAndSlide",We="onKeyDown",$e="onMenuClick",Ot="scrollPage",Mt="landscapeScroll",bn="scrollBeyondFullpage",Yt="onPerformMovement",to="onSlideLeave",no="onLeave",io="afterSectionLoads",Oi="afterSlideLoads";function ro(f){J.L(ke,{e:f,target:f.target})}function Hr(){["click","touchstart"].forEach(function(f){Ie(f,ro,{passive:!1})})}function na(){Y({J:!0})}J.R(Ae,function(){["click","touchstart"].forEach(function(f){ge(f,ro,{passive:!1})}),Le("focus",na),J.R(we,Hr)});var so="fullpage-wrapper",pi="."+so,kr="fp-responsive",L="fp-notransition",$="fp-destroyed",ae="fp-enabled",q="active",le=".active",ze="fp-completely",Ye="fp-section",qe="."+Ye,Qe=".fp-tableCell",it="#fp-nav",Ze="fp-slide",ot="."+Ze,Tt=".fp-slide.active",wt="fp-slides",Ht=".fp-slides",Tn="fp-slidesContainer",Rt="."+Tn,ut="fp-table",Zn="fp-overflow",Ct="."+Zn,An="fp-is-overflow",zr=".fp-slidesNav",Fi=".fp-slidesNav a",Vr="fp-controlArrow",Gt="."+Vr,Jn="fp-prev",lr=".fp-controlArrow.fp-prev",an=".fp-controlArrow.fp-next",Bi={menu:!1,anchors:[],lockAnchors:!1,navigation:!1,navigationPosition:"right",navigationTooltips:[],showActiveTooltip:!1,slidesNavigation:!1,slidesNavPosition:"bottom",scrollBar:!1,hybrid:!1,licenseKey:"",credits:{enabled:!0,label:"Made with fullPage.js",position:"right"},css3:!0,scrollingSpeed:700,autoScrolling:!0,fitToSection:!0,en:600,easing:"easeInOutCubic",easingcss3:"ease",loopBottom:!1,loopTop:!1,loopHorizontal:!0,continuousVertical:!1,continuousHorizontal:!1,scrollHorizontally:!1,interlockedSlides:!1,dragAndMove:!1,offsetSections:!1,resetSliders:!1,fadingEffect:!1,normalScrollElements:null,scrollOverflow:!0,scrollOverflowReset:!1,touchSensitivity:5,touchWrapper:null,bigSectionsDestination:null,keyboardScrolling:!0,animateAnchor:!0,recordHistory:!0,allowCorrectDirection:!1,scrollOverflowMacStyle:!0,controlArrows:!0,controlArrowsHTML:['<div class="fp-arrow"></div>','<div class="fp-arrow"></div>'],controlArrowColor:"#fff",verticalCentered:!0,sectionsColor:[],paddingTop:0,paddingBottom:0,fixedElements:null,responsive:0,responsiveWidth:0,responsiveHeight:0,responsiveSlides:!1,parallax:!1,parallaxOptions:{type:"reveal",percentage:62,property:"translate"},cards:!1,cardsOptions:{perspective:100,fadeContent:!0,fadeBackground:!0},sectionSelector:".section",slideSelector:".slide",afterLoad:null,beforeLeave:null,onLeave:null,afterRender:null,afterResize:null,afterReBuild:null,afterSlideLoad:null,onSlideLeave:null,afterResponsive:null,onScrollOverflow:null,lazyLoading:!0,observer:!0},cr=null,oo=!1,jl=g({},Bi),ia=null;function Ke(f){return cr}function U(){return ia||Bi}function Gr(){return jl}function ra(f,_,M){ia[f]=_,M!=="internal"&&(jl[f]=_)}function Qf(){if(!U().anchors.length){var f=p(U().sectionSelector.split(",").join("[data-anchor],")+"[data-anchor]",cr);f.length&&f.length===p(U().sectionSelector,cr).length&&(oo=!0,f.forEach(function(M){U().anchors.push(ne(M,"data-anchor").toString())}))}if(!U().navigationTooltips.length){var _=p(U().sectionSelector.split(",").join("[data-tooltip],")+"[data-tooltip]",cr);_.length&&_.forEach(function(M){U().navigationTooltips.push(ne(M,"data-tooltip").toString())})}}function eh(f){return window["fp_"+f+"Extension"]!==void 0}function Ft(f){var _=U();return _[f]!==null&&Object.prototype.toString.call(_[f])==="[object Array]"?_[f].length&&h[f]:_[f]&&h[f]}function Je(f,_,M){if(Ft(f))return I(h[f][_])?h[f][_](M):h[f][_]}function sa(){return Je("dragAndMove","isAnimating")}function th(){return Je("dragAndMove","isGrabbing")}function ql(f){if(U().offsetSections&&h.offsetSections){var _=Je("offsetSections","getWindowHeight",f);return _!==""?Math.round(_)+"px":_}return E()+"px"}function nh(f,_){f.insertBefore(_,f.firstChild)}function ln(f){var _="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=";function M(k){var he,re,Ve,Oe,nt,dt,tt="",_t=0;for(k=k.replace(/[^A-Za-z0-9+/=]/g,"");_t<k.length;)he=_.indexOf(k.charAt(_t++))<<2|(Oe=_.indexOf(k.charAt(_t++)))>>4,re=(15&Oe)<<4|(nt=_.indexOf(k.charAt(_t++)))>>2,Ve=(3&nt)<<6|(dt=_.indexOf(k.charAt(_t++))),tt+=String.fromCharCode(he),nt!=64&&(tt+=String.fromCharCode(re)),dt!=64&&(tt+=String.fromCharCode(Ve));return tt=function(Et){for(var $t,Wt="",It=0,Dt=0,pt=0;It<Et.length;)(Dt=Et.charCodeAt(It))<128?(Wt+=String.fromCharCode(Dt),It++):Dt>191&&Dt<224?(pt=Et.charCodeAt(It+1),Wt+=String.fromCharCode((31&Dt)<<6|63&pt),It+=2):(pt=Et.charCodeAt(It+1),$t=Et.charCodeAt(It+2),Wt+=String.fromCharCode((15&Dt)<<12|(63&pt)<<6|63&$t),It+=3);return Wt}(tt),tt}function P(k){return k.slice(3).slice(0,-3)}return function(k){var he=k.split("_");if(he.length>1){var re=he[1];return M(k.replace(P(he[1]),"").split("_")[0].slice(2).slice(0,-2))+"_"+M(re.slice(3).slice(0,-3))}return P(k)}(M(f))}o.fp_utils=o.fp_utils||{},Object.assign(o.fp_utils,{prependTo:nh,toggleClass:function(f,_,M){if(f.classList&&M==null)f.classList.toggle(_);else{var P=b(f,_);P&&M==null||!M?Z(f,_):(!P&&M==null||M)&&H(f,_)}}});var ih=function(f){this.anchor=f.anchor,this.item=f.item,this.index=f.index(),this.isLast=this.index===f.item.parentElement.querySelectorAll(f.selector).length-1,this.isFirst=!this.index,this.isActive=f.isActive},Hn=function(f,_){this.parent=this.parent||null,this.selector=_,this.anchor=ne(f,"data-anchor")||U().anchors[R(f,U().sectionSelector)],this.item=f,this.isVisible=v(f),this.isActive=b(f,q),this.on=b(f,Zn)||p(Ct,f)[0]!=null,this.rn=_===U().sectionSelector,this.container=z(f,Rt)||z(f,pi),this.index=function(){return this.siblings().indexOf(this)}};function Yl(f){return f.map(function(_){return _.item})}function Kl(f,_){return f.find(function(M){return M.item===_})}Hn.prototype.siblings=function(){return this.rn?this.isVisible?T.N:T.an:this.parent?this.parent.slides:0},Hn.prototype.prev=function(){var f=this.siblings(),_=(this.rn?f.indexOf(this):this.parent.slides.indexOf(this))-1;return _>=0?f[_]:null},Hn.prototype.next=function(){var f=this.siblings(),_=(this.rn?f.indexOf(this):this.parent.slides.indexOf(this))+1;return _<f.length?f[_]:null},Hn.prototype.prevPanel=function(){return this===this.prev()?this.parent?this.parent.prev():null:this.prev()||(this.parent?this.parent.prev():null)},Hn.prototype.nextPanel=function(){return this===this.next()?this.parent?this.parent.next():null:this.next()||(this.parent?this.parent.next():null)},Hn.prototype.ln=function(){return this.rn?T.N:T.un};var rh,sh=function(f){ih.call(this,f)},J_=function(f){ih.call(this,f)};function ur(f){var _=p(Tt,f);return _.length&&(f=_[0]),f}function oh(f){return f?f.activeSlide?f.activeSlide:f:null}function Wr(f){var _,M,P=U();return P.autoScrolling&&!P.scrollBar?(_=-f,M=p(pi)[0]):(_=f,M=window),{options:_,element:M}}function ah(f,_){!U().autoScrolling||U().scrollBar||f.self!=window&&b(f,wt)?f.self!=window&&b(f,wt)?f.scrollLeft=_:f.scrollTo(0,_):f.style.top=_+"px"}function $l(f){var _="transform "+U().scrollingSpeed+"ms "+U().easingcss3;return Z(f,L),C(f,{"-webkit-transition":_,transition:_})}function Zl(f,_){var M=f.index(),P=R(_,qe);return M==P?"none":M>P?"up":"down"}function oa(f){return H(f,L)}function Jl(f){return{"-webkit-transform":f,"-moz-transform":f,"-ms-transform":f,transform:f}}function lh(f,_){_?$l(Ke()):oa(Ke()),clearTimeout(rh),C(Ke(),Jl(f)),h.test.cn=f,rh=setTimeout(function(){Z(Ke(),L)},10)}function fr(f){var _=Math.round(f);if(U().css3&&U().autoScrolling&&!U().scrollBar)lh("translate3d(0px, -"+_+"px, 0px)",!1);else if(U().autoScrolling&&!U().scrollBar)C(Ke(),{top:-_+"px"}),h.test.top=-_+"px";else{var M=Wr(_);ah(M.element,M.options)}}function ao(f,_){_!=="internal"&&Je("fadingEffect","update",f),Je("cards","update_",f),ra("scrollingSpeed",f,_)}h.setScrollingSpeed=ao;var lo,Lt=null,co=null,aa=null;function la(f,_,M,P){var k,he=function(nt){return nt.self!=o&&b(nt,wt)?nt.scrollLeft:!U().autoScrolling||U().scrollBar?Ne():nt.offsetTop}(f),re=_-he,Ve=!1,Oe=T.G;Y({G:!0}),lo&&window.cancelAnimationFrame(lo),lo=function(nt){k||(k=nt);var dt=Math.floor(nt-k);if(T.G){var tt=_;M&&(tt=o.fp_easings[U().easing](dt,he,re,M)),dt<=M&&ah(f,tt),dt<M?window.requestAnimationFrame(lo):P===void 0||Ve||(P(),Y({G:!1}),Ve=!0)}else Ve||Oe||(P(),Y({G:!1}),Ve=!0)},window.requestAnimationFrame(lo)}function Hi(f){return f&&!f.item?new sh(new pr(f)):f?new sh(f):null}function Ql(f){return f?new J_(f):null}function Qn(f,_){var M=function(P,k){var he={afterRender:function(){return{section:Hi(V().P),sn:Ql(V().P.activeSlide)}},onLeave:function(){return{origin:Hi(k.items.origin),destination:Hi(k.items.destination),direction:k.direction,trigger:V().H}},afterLoad:function(){return he.onLeave()},afterSlideLoad:function(){return{section:Hi(k.items.section),origin:Hi(k.items.origin),destination:Hi(k.items.destination),direction:k.direction,trigger:V().H}},onSlideLeave:function(){return he.afterSlideLoad()},beforeLeave:function(){return he.onLeave()},onScrollOverflow:function(){return{section:Hi(V().P),sn:Ql(V().P.activeSlide),position:k.position,direction:k.direction}}};return he[P]()}(f,_);return O(Ke(),f,M),U()[f].apply(M[Object.keys(M)[0]],w(M))!==!1}function ca(f){var _=ur(f);p("video, audio",_).forEach(function(M){M.hasAttribute("data-autoplay")&&typeof M.play=="function"&&M.play()}),p('iframe[src*="youtube.com/embed/"]',_).forEach(function(M){M.hasAttribute("data-autoplay")&&ch(M),M.onload=function(){M.hasAttribute("data-autoplay")&&ch(M)}})}function ch(f){f.contentWindow.postMessage('{"event":"command","func":"playVideo","args":""}',"*")}function ec(f){var _=ur(f);p("video, audio",_).forEach(function(M){M.hasAttribute("data-keepplaying")||typeof M.pause!="function"||M.pause()}),p('iframe[src*="youtube.com/embed/"]',_).forEach(function(M){/youtube\.com\/embed\//.test(ne(M,"src"))&&!M.hasAttribute("data-keepplaying")&&M.contentWindow.postMessage('{"event":"command","func":"pauseVideo","args":""}',"*")})}function Xr(f){U().lazyLoading&&p("img[data-src], img[data-srcset], source[data-src], source[data-srcset], video[data-src], audio[data-src], iframe[data-src]",ur(f)).forEach(function(_){if(["src","srcset"].forEach(function(P){var k=ne(_,"data-"+P);k!=null&&k&&(ue(_,P),_.addEventListener("load",function(){}))}),W(_,"source")){var M=z(_,"video, audio");M&&(M.load(),M.onloadeddata=function(){})}})}function uh(){var f=V().P.item,_=V().P.activeSlide,M=fh(f),P=String(M);_&&(P=P+"-"+fh(_.item)),P=P.replace("/","-").replace("#","");var k=new RegExp("\\b\\s?fp-viewing-[^\\s]+\\b","g");Lt.className=Lt.className.replace(k,""),H(Lt,"fp-viewing-"+P)}function fh(f){if(!f)return null;var _=ne(f,"data-anchor"),M=R(f);return _==null&&(_=M),_}function tc(f,_,M){var P="";U().anchors.length&&!U().lockAnchors&&(f?(M!=null&&(P=M),_==null&&(_=f),Y({B:_}),hh(P+"/"+_)):(f!=null&&Y({B:_}),hh(M))),uh()}function hh(f){if(U().recordHistory)location.hash=f;else if(l||u)o.history.replaceState(void 0,void 0,"#"+f);else{var _=o.location.href.split("#")[0];o.location.replace(_+"#"+f)}}function dh(f,_,M){var P=_==="Section"?U().anchors[f]:ne(M,"data-anchor");return encodeURI(U().navigationTooltips[f]||P||_+" "+(f+1))}function Q_(f){f.cancelable&&j(f),Y({H:"horizontalNav"});var _=z(this,qe),M=p(Ht,z(this,qe))[0],P=Kl(V().N,_).slides[R(z(this,"li"))];J.L(Mt,{slides:M,destination:P.item})}function ph(f,_){U().slidesNavigation&&f!=null&&(Z(p(le,f),q),H(p("a",p("li",f)[_]),q))}var ua,hr={};function fa(f,_,M){_!=="all"?hr[M][_]=f:Object.keys(hr[M]).forEach(function(P){hr[M][P]=f})}function Kt(){return hr}function e0(){var f=z(this,qe);b(this,Jn)?Kt().m.left&&(Y({H:"slideArrow"}),J.L(je,{section:f})):Kt().m.right&&(Y({H:"slideArrow"}),J.L(Xe,{section:f}))}function mh(f){!U().loopHorizontal&&U().controlArrows&&(K(p(lr,f.section),f.slideIndex!==0),K(p(an,f.section),D(f.destiny)!=null))}function t0(){clearTimeout(ua),Y({W:!1})}function dr(f,_,M){var P=z(f,qe),k=V().N.filter(function(Ve){return Ve.item==P})[0],he=k.slides.filter(function(Ve){return Ve.item==_})[0],re={slides:f,destiny:_,direction:M,destinyPos:{left:_.offsetLeft},slideIndex:he.index(),section:P,sectionIndex:k.index(),anchorLink:k.anchor,slidesNav:p(zr,P)[0],slideAnchor:he.anchor,prevSlide:k.activeSlide.item,prevSlideIndex:k.activeSlide.index(),items:{section:k,origin:k.activeSlide,destination:he},localIsResizing:T.F};re.xMovement=_h(re.prevSlideIndex,re.slideIndex),re.direction=re.direction?re.direction:re.xMovement,re.localIsResizing||Y({canScroll:!1}),Je("parallax","applyHorizontal",re),Je("cards","apply",re),Je("dropEffect","apply",re),Je("waterEffect","apply",re),U().onSlideLeave&&!re.localIsResizing&&re.xMovement!=="none"&&I(U().onSlideLeave)&&Qn("onSlideLeave",re)===!1?Y({W:!1}):(Ft("dropEffect")&&U().dropEffect||(H(_,q),Z(He(_),q)),ei(),re.localIsResizing||(ec(re.prevSlide),Xr(_)),mh(re),k.isActive&&!re.localIsResizing&&tc(re.slideIndex,re.slideAnchor,re.anchorLink),Je("continuousHorizontal","apply",re),J.L(to,re),th()?nc(re):gh(f,re,!0),U().interlockedSlides&&h.interlockedSlides&&(Ft("continuousHorizontal")&&M!==void 0&&M!==re.xMovement||Je("interlockedSlides","apply",re)))}function gh(f,_,M){var P=_.destinyPos;if(ph(_.slidesNav,_.slideIndex),Y({scrollX:Math.round(P.left)}),U().css3){var k="translate3d(-"+Math.round(P.left)+"px, 0px, 0px)";h.test.dn[_.sectionIndex]=k,Ft("dragAndMove")&&_.vn!==void 0||$l(p(Rt,f)),C(p(Rt,f),Jl(k)),Ft("interlockedSlides")||clearTimeout(ua),ua=setTimeout(function(){M&&nc(_)},U().scrollingSpeed)}else h.test.left[_.sectionIndex]=Math.round(P.left),la(f,Math.round(P.left),U().scrollingSpeed,function(){M&&nc(_)})}function _h(f,_){return f==_?"none":f>_?"left":"right"}function n0(){clearTimeout(ua)}function nc(f){Je("continuousHorizontal","afterSlideLoads",f),Je("dragAndMove","afterSlideLoads",f),f.localIsResizing||(Je("parallax","afterSlideLoads"),Je("scrollOverflowReset","setPrevious",f.prevSlide),Je("scrollOverflowReset","reset"),I(U().afterSlideLoad)&&Qn("afterSlideLoad",f),Y({canScroll:!0}),ca(f.destiny),J.L(Oi,f)),Y({W:!1}),Je("interlockedSlides","interlockedSlides",f)}function uo(f,_){ao(0,"internal"),_!==void 0&&Y({F:!0}),dr(z(f,Ht),f),_!==void 0&&Y({F:!1}),ao(Gr().scrollingSpeed,"internal")}function ic(f,_){ra("recordHistory",f,_)}function jr(f,_){f||fr(0),ra("autoScrolling",f,_);var M=V().P.item;if(U().autoScrolling&&!U().scrollBar)C(aa,{overflow:"hidden",height:"100%"}),Z(Lt,"fp-scrollable"),ic(Gr().recordHistory,"internal"),C(Ke(),{"-ms-touch-action":"none","touch-action":"none"}),M!=null&&fr(M.offsetTop);else if(C(aa,{overflow:"visible",height:"initial"}),H(Lt,"fp-scrollable"),ic(!!U().autoScrolling&&Gr().recordHistory,"internal"),C(Ke(),{"-ms-touch-action":"","touch-action":""}),oa(Ke()),M!=null){var P=Wr(M.offsetTop);P.element.scrollTo(0,P.options)}O(Ke(),"setAutoScrolling",f)}function rc(){for(var f=p(Tt),_=0;_<f.length;_++)uo(f[_],"internal")}function vh(){var f=p(".fp-auto-height")[0]||hc()&&p(".fp-auto-height-responsive")[0];U().lazyLoading&&f&&p(".fp-section:not(.active)").forEach(function(_){var M,P,k,he,re;P=(M=_.getBoundingClientRect()).top,k=M.bottom,he=P+2<T.q&&P>0,re=k>2&&k<T.q,(he||re)&&Xr(_)})}function i0(){O(B(this),"click")}function xh(){ve(p(it));var f=a.createElement("div");f.setAttribute("id","fp-nav");var _=a.createElement("ul");f.appendChild(_),ce(f,Lt);var M=p(it)[0];H(M,"fp-"+U().navigationPosition),U().showActiveTooltip&&H(M,"fp-show-active");for(var P="",k=0;k<V().N.length;k++){var he=V().N[k],re="";U().anchors.length&&(re=he.anchor),P+='<li><a href="#'+encodeURI(re)+'"><span class="fp-sr-only">'+dh(he.index(),"Section")+"</span><span></span></a>";var Ve=U().navigationTooltips[he.index()];Ve!==void 0&&Ve!==""&&(P+='<div class="fp-tooltip fp-'+U().navigationPosition+'">'+Ve+"</div>"),P+="</li>"}p("ul",M)[0].innerHTML=P;var Oe=p("li",p(it)[0])[V().P.index()];H(p("a",Oe),q)}function r0(f){f.preventDefault&&j(f),Y({H:"verticalNav"});var _=R(z(this,"#fp-nav li"));J.L(Ot,{destination:V().N[_]})}function sc(f,_){var M;M=f,U().menu&&U().menu.length&&p(U().menu).forEach(function(P){P!=null&&(Z(p(le,P),q),H(p('[data-menuanchor="'+M+'"]',P),q))}),function(P,k){var he=p(it)[0];U().navigation&&he!=null&&he.style.display!=="none"&&(Z(p(le,he),q),H(P?p('a[href="#'+P+'"]',he):p("a",p("li",he)[k]),q))}(f,_)}hr.m={up:!0,down:!0,left:!0,right:!0},hr.k=g({},hr.m),J.R(ke,function(f){var _=f.target;(W(_,Gt)||z(_,Gt))&&e0.call(_,f)}),h.landscapeScroll=dr,J.R(Ae,function(){J.R(Yt,t0)}),h.setRecordHistory=ic,h.setAutoScrolling=jr,h.test.setAutoScrolling=jr,new Date().getTime();var oc,ac,lc,cc,fo,uc,s0=(ac=!0,lc=new Date().getTime(),cc=!o.fullpage_api,function(f,_){var M=new Date().getTime(),P=f==="wheel"?U().scrollingSpeed:100;return ac=cc||M-lc>=P,cc=!o.fullpage_api,ac&&(oc=_(),lc=M),oc===void 0||oc});function Sh(f,_){if(I(U().beforeLeave))return s0(V().H,function(){return Qn(f,_)})}function qr(f,_,M){var P=f.item;if(P!=null){var k,he,re={element:P,callback:_,isMovementUp:M,dtop:yh(P),yMovement:Zl(V().P,P),anchorLink:f.anchor,sectionIndex:f.index(),activeSlide:f.activeSlide?f.activeSlide.item:null,leavingSection:V().P.index()+1,localIsResizing:T.F,items:{origin:V().P,destination:f},direction:null};if(!(V().P.item==P&&!T.F||U().scrollBar&&Ne()===re.dtop&&!b(P,"fp-auto-height"))){if(re.activeSlide!=null&&(k=ne(re.activeSlide,"data-anchor"),he=R(re.activeSlide,null)),!re.localIsResizing){var Ve=re.yMovement;if(M!==void 0&&(Ve=M?"up":"down"),re.direction=Ve,eh("dropEffect")&&h.dropEffect.onLeave_(re),eh("waterEffect")&&h.waterEffect.onLeave_(re),I(U().beforeLeave)&&Sh("beforeLeave",re)===!1||I(U().onLeave)&&!Qn("onLeave",re))return}Je("parallax","apply",re),Je("cards","apply",re),Je("dropEffect","apply",re),Je("waterEffect","apply",re),U().autoScrolling&&U().continuousVertical&&re.isMovementUp!==void 0&&(!re.isMovementUp&&re.yMovement=="up"||re.isMovementUp&&re.yMovement=="down")&&(re=function(Oe){Y({nn:!0});var nt=V().P.item;return Oe.isMovementUp?Re(nt,_e(nt,qe)):Q(nt,Be(nt,qe).reverse()),fr(V().P.item.offsetTop),rc(),Oe.pn=nt,Oe.dtop=Oe.element.offsetTop,Oe.yMovement=Zl(V().P,Oe.element),Oe.leavingSection=Oe.items.origin.index()+1,Oe.sectionIndex=Oe.items.destination.index(),O(Ke(),"onContinuousVertical",Oe),Oe}(re)),Je("scrollOverflowReset","setPrevious",V().P.item),re.localIsResizing||ec(V().P.item),Ft("dropEffect")&&U().dropEffect||(H(P,q),Z(He(P),q)),ei(),Xr(P),Y({canScroll:h.test.hn}),tc(he,k,re.anchorLink),J.L(no,re),function(Oe){var nt=U().scrollingSpeed<700,dt=nt?700:U().scrollingSpeed;if(Y({Y:"none",scrollY:Math.round(Oe.dtop)}),J.L(Yt),U().css3&&U().autoScrolling&&!U().scrollBar)lh("translate3d(0px, -"+Math.round(Oe.dtop)+"px, 0px)",!0),Ft("waterEffect")&&rc(),U().scrollingSpeed?(clearTimeout(fo),fo=setTimeout(function(){ha(Oe),Y({canScroll:!nt||h.test.hn})},U().scrollingSpeed)):ha(Oe);else{var tt=Wr(Oe.dtop);h.test.top=-Oe.dtop+"px",clearTimeout(fo),la(tt.element,tt.options,U().scrollingSpeed,function(){U().scrollBar?fo=setTimeout(function(){ha(Oe)},30):(ha(Oe),Y({canScroll:!nt||h.test.hn}))})}nt&&(clearTimeout(uc),uc=setTimeout(function(){Y({canScroll:!0})},dt))}(re),Y({Z:re.anchorLink}),sc(re.anchorLink,function(Oe){return Oe.pn!=null?Oe.isMovementUp?T.j-1:0:Oe.sectionIndex}(re))}}}function yh(f){var _=f.offsetHeight,M=f.offsetTop,P=M,k=Ft("dragAndMove")&&Je("dragAndMove","isGrabbing")?Je("dragAndMove","isScrollingDown"):M>T.K,he=P-E()+_,re=U().bigSectionsDestination;return _>E()?(k||re)&&re!=="bottom"||(P=he):(k||T.F&&D(f)==null)&&(P=he),Ft("offsetSections")&&(P=h.offsetSections.getSectionPosition_(k,P,f)),Y({K:P}),P}function ha(f){Y({C:!1}),function(_){_.pn!=null&&(_.isMovementUp?Re(p(qe)[0],_.pn):Q(p(qe)[V().N.length-1],_.pn),fr(V().P.item.offsetTop),function(){for(var M=p(Tt),P=0;P<M.length;P++)uo(M[P],"internal")}(),_.sectionIndex=_.items.destination.index(),_.leavingSection=_.items.origin.index()+1,Y({nn:!1}))}(f),I(U().afterLoad)&&!f.localIsResizing&&Qn("afterLoad",f),Je("parallax","afterLoad"),Je("waterEffect","afterLoad"),Je("dropEffect","afterLoad"),Je("scrollOverflowReset","reset"),Je("resetSliders","apply",f),ei(),f.localIsResizing||ca(f.element),H(f.element,ze),Z(He(f.element),ze),vh(),Y({canScroll:!0}),J.L(io,f),I(f.callback)&&f.callback()}function fc(f,_){ra("fitToSection",f,_)}function Mh(){T.canScroll&&(Y({F:!0}),qr(T.P),Y({F:!1}))}function Eh(){var f=U().responsive||U().responsiveWidth,_=U().responsiveHeight,M=f&&o.innerWidth<f,P=_&&o.innerHeight<_;f&&_?da(M||P):f?da(M):_&&da(P)}function da(f){var _=hc();f?_||(jr(!1,"internal"),fc(!1,"internal"),de(p(it)),H(Lt,kr),I(U().afterResponsive)&&U().afterResponsive.call(Ke(),f),Je("responsiveSlides","toSections"),O(Ke(),"afterResponsive",f)):_&&(jr(Gr().autoScrolling,"internal"),fc(Gr().autoScrolling,"internal"),Me(p(it)),Z(Lt,kr),I(U().afterResponsive)&&U().afterResponsive.call(Ke(),f),Je("responsiveSlides","toSlides"),O(Ke(),"afterResponsive",f))}function hc(){return b(Lt,kr)}function bh(f){U().verticalCentered&&(!U().scrollOverflow&&et.gn(f.item)||et.mn(f)||b(f.item,ut)||H(f.item,ut))}h.moveTo=moveTo,h.getScrollY=function(){return T.scrollY},J.R(we,function(){clearTimeout(fo),clearTimeout(uc)}),h.setFitToSection=fc,h.fitToSection=Mh,h.setResponsive=da;var dc,Th=null;function pc(f){var _=f.item,M=f.wn.length,P=f.index();!V().P&&f.isVisible&&(H(_,q),ei(),Th=V().P.item),Ft("offsetSections")&&C(_,{height:ql(_)}),U().paddingTop&&C(_,{"padding-top":U().paddingTop}),U().paddingBottom&&C(_,{"padding-bottom":U().paddingBottom}),U().sectionsColor[P]!==void 0&&C(_,{"background-color":U().sectionsColor[P]}),U().anchors[P]!==void 0&&_.setAttribute("data-anchor",f.anchor),M||bh(f)}function Ah(){U().scrollOverflow&&!U().scrollBar&&(et.bn(),et.Sn())}function o0(){J.removeListener(Ge,Ah),Ie("keyup",et.yn)}h.getActiveSection=function(){return V().P},J.R(Ae,function(){J.R(Ge,Ah),J.R(no,et.onLeave),J.R(to,et.onLeave),J.R(Oi,et.afterLoad),J.R(io,et.afterLoad),J.R(we,o0),ge("keyup",et.yn)});var mc,et={Mn:null,Tn:!0,An:!0,xn:null,On:null,kn:function(f){if(!T.canScroll)return j(f),!1},En:function(f){if(!me()&&U().keyboardScrolling&&[38,33,32,40,34,36,35].indexOf(f.keyCode)>-1&&!et.An)return j(f),!1},yn:function(){et.Tn=T.canScroll},onLeave:function(){clearTimeout(dc),et.An=!1},afterLoad:function(){et.An=!1,clearTimeout(dc),dc=setTimeout(function(){et.Tn=T.canScroll},200)},Rn:function(){a.activeElement===this.Mn&&(this.Mn.blur(),et.An=!1)},Sn:function(){if(U().scrollOverflow&&et.Tn){et.Rn();var f=et.Ln(V().P.item);!f||l||u||(this.Mn=f,requestAnimationFrame(function(){f.focus(),et.An=!0})),et.Tn=!1}},bn:function(){U().scrollOverflowMacStyle&&!c&&H(Lt,"fp-scroll-mac"),V().un.forEach(function(f){if(!(f.slides&&f.slides.length||b(f.item,"fp-auto-height-responsive")&&hc())){var _,M=ur(f.item),P=et.gn(f.item),k=(_=f).rn?_:_.parent;if(d){var he=P?"addClass":"removeClass";De[he](k.item,An),De[he](f.item,An)}else H(k.item,An),H(f.item,An);f.on||(et.jn(M),et.zn(M)),f.on=!0}})},zn:function(f){et.Ln(f).addEventListener("scroll",et.Dn),f.addEventListener("wheel",et.kn,{passive:!1}),f.addEventListener("keydown",et.En,{passive:!1})},jn:function(f){var _=document.createElement("div");_.className=Zn,ye(f,_),_.setAttribute("tabindex","-1")},Nn:function(f){var _=p(Ct,f)[0];_&&(xe(_),f.removeAttribute("tabindex"))},Ln:function(f){var _=ur(f);return p(Ct,_)[0]||_},on:function(f){return b(f,Zn)||p(Ct,f)[0]!=null},mn:function(f){return f.rn&&f.activeSlide?f.activeSlide.on:f.on},gn:function(f){return et.Ln(f).scrollHeight>o.innerHeight},Pn:function(f,_){if(!T.canScroll)return!1;if(U().scrollBar)return!0;var M=et.Ln(_);if(!U().scrollOverflow||!b(M,Zn)||b(_,"fp-noscroll")||b(ur(_),"fp-noscroll"))return!0;var P=d?1:0,k=M.scrollTop,he=f==="up"&&k<=0,re=f==="down"&&M.scrollHeight<=Math.ceil(M.offsetHeight+k)+P,Ve=he||re;return Ve||(this.xn=new Date().getTime()),Ve},Hn:function(){this.On=new Date().getTime();var f=this.On-et.xn,_=(l||u)&&T.X,M=T._&&f>600;return _&&f>400||M},Dn:(mc=0,function(f){var _=f.target.scrollTop,M=T.Y!=="none"?T.Y:mc<_?"down":"up";mc=_,I(U().onScrollOverflow)&&Qn("onScrollOverflow",{position:_,direction:M}),b(f.target,Zn)&&T.canScroll&&et.Pn(M,f.target)&&et.Hn()&&et.gn(V().P.item)&&J.L(Ce,{direction:M})})},gc=null,_c=null;function ei(){T.P=null,T.N.map(function(f){var _=b(f.item,q);f.isActive=_,f.on=et.on(f.item),_&&(T.P=f),f.slides.length&&(f.activeSlide=null,f.slides.map(function(M){var P=b(M.item,q);M.on=et.on(f.item),M.isActive=P,P&&(f.activeSlide=M)}))}),function(){var f=T.P,_=!!T.P&&T.P.slides.length,M=T.P?T.P.activeSlide:null;if(!f&&T.N.length&&!V().C){if(gc){var P=Rh(gc,T.N);P&&(T.P=P,T.P.isActive=!0,H(T.P.item,q)),T.P&&fr(T.P.item.offsetTop)}if(_&&!M&&_c){var k=Rh(_c,T.P.slides);k&&(T.P.activeSlide=k,T.P.activeSlide.isActive=!0,H(T.P.activeSlide.item,q)),T.P.activeSlide&&uo(T.P.activeSlide.item,"internal")}}}(),O(Ke(),"onUpdateStateDone")}function pa(){var f=p(U().sectionSelector+", "+qe,Ke()),_=x(f),M=Array.from(f).map(function(he){return new pr(he)}),P=M.filter(function(he){return he.isVisible}),k=P.reduce(function(he,re){return he.concat(re.slides)},[]);gc=wh(T.P),_c=wh(T.P?T.P.activeSlide:null),T.j=_.length,T.D=P.reduce(function(he,re){return he+re.slides.length},0),T.N=P,T.an=M,T.slides=k,T.un=T.N.concat(T.slides)}function wh(f){if(!f)return null;var _=f?f.item:null,M=f.rn?T.an:T.P.Cn;if(_){var P=Kl(M,_);return P?P.index():null}return null}function Rh(f,_){var M,P=f-1,k=f;do{if(M=_[P]||_[k])break;P-=1,k+=1}while(P>=0||k<_.length);return M}var pr=function(f){var _=this;[].push.call(arguments,U().sectionSelector),Hn.apply(this,arguments),this.wn=p(U().slideSelector,f),this.Cn=Array.from(this.wn).map(function(M){return new ma(M,_)}),this.slides=this.Cn.filter(function(M){return M.isVisible}),this.activeSlide=this.slides.length?this.slides.filter(function(M){return M.isActive})[0]||this.slides[0]:null};pr.prototype=Hn.prototype,pr.prototype.constructor=pr;var ho,ma=function(f,_){this.parent=_,Hn.call(this,f,U().slideSelector)};function Ch(){H(p(U().sectionSelector,Ke()),Ye),H(p(U().slideSelector,Ke()),Ze)}function vc(f){var _=f.slides.length,M=f.wn,P=f.slides,k=100*_,he=100/_;if(!p(Ht,f.item)[0]){var re=a.createElement("div");re.className=wt,pe(M,re);var Ve=a.createElement("div");Ve.className=Tn,pe(M,Ve)}C(p(Rt,f.item),{width:k+"%"}),_>1&&(U().controlArrows&&function(nt){var dt=nt.item,tt=[se(U().controlArrowsHTML[0]),se(U().controlArrowsHTML[1])];Q(p(Ht,dt)[0],tt),H(tt,Vr),H(tt[0],Jn),H(tt[1],"fp-next"),U().controlArrowColor!=="#fff"&&(C(p(an,dt),{"border-color":"transparent transparent transparent "+U().controlArrowColor}),C(p(lr,dt),{"border-color":"transparent "+U().controlArrowColor+" transparent transparent"})),U().loopHorizontal||de(p(lr,dt))}(f),U().slidesNavigation&&function(nt){var dt=nt.item,tt=nt.slides.length;ce(se('<div class="fp-slidesNav"><ul></ul></div>'),dt);var _t=p(zr,dt)[0];H(_t,"fp-"+U().slidesNavPosition);for(var Et=0;Et<tt;Et++)ce(se('<li><a href="#"><span class="fp-sr-only">'+dh(Et,"Slide",p(ot,dt)[Et])+"</span><span></span></a></li>"),p("ul",_t)[0]);C(_t,{"margin-left":"-"+_t.innerWidth/2+"px"});var $t=nt.activeSlide?nt.activeSlide.index():0;H(p("a",p("li",_t)[$t]),q)}(f)),P.forEach(function(nt){C(nt.item,{width:he+"%"}),U().verticalCentered&&bh(nt)});var Oe=Ft("responsiveSlides")?null:f.activeSlide||null;Oe!=null&&T.P&&(T.P.index()!==0||T.P.index()===0&&Oe.index()!==0)?(uo(Oe.item,"internal"),H(Oe.item,"fp-initial")):H(M[0],q)}ma.prototype=Hn.prototype,ma.prototype.constructor=pr;var Lh={attributes:!1,subtree:!0,childList:!0,characterData:!0};function Ph(){return Je("responsiveSlides","isResponsiveSlidesChanging")||x(p(U().slideSelector,Ke())).length!==V().D}function xc(f){var _=Ph();(Ph()||Je("responsiveSlides","isResponsiveSlidesChanging")||x(p(U().sectionSelector,Ke())).length!==V().j)&&!T.nn&&(U().observer&&ho&&ho.disconnect(),pa(),ei(),U().anchors=[],ve(p(it)),Je("responsiveSlides","isResponsiveSlidesChanging")||Ch(),Qf(),U().navigation&&xh(),_&&(ve(p(zr)),ve(p(Gt))),V().N.forEach(function(M){M.slides.length?_&&vc(M):pc(M)})),U().observer&&ho&&p(pi)[0]&&ho.observe(p(pi)[0],Lh)}J.R(Ae,function(){var f,_,M;U().observer&&"MutationObserver"in window&&p(pi)[0]&&(f=p(pi)[0],_=Lh,(M=new MutationObserver(xc)).observe(f,_),ho=M),J.R(Ue,xc)}),h.render=xc;var a0=function(){var f=!1;try{var _=Object.defineProperty({},"passive",{get:function(){f=!0}});Le("testPassive",null,_),S("testPassive",null,_)}catch{}return function(){return f}}();function Ih(){return!!a0()&&{passive:!1}}var Dh,Nh,Sc,ki,ga=(Sc=new Date().getTime(),ki=[],{In:function(f){var _=(f=f||o.event).wheelDelta||-f.deltaY||-f.detail,M=Math.max(-1,Math.min(1,_)),P=f.wheelDeltaX!==void 0||f.deltaX!==void 0;Dh=Math.abs(f.wheelDeltaX)<Math.abs(f.wheelDelta)||Math.abs(f.deltaX)<Math.abs(f.deltaY)||!P;var k=new Date().getTime();Nh=M<0?"down":"up",ki.length>149&&ki.shift(),ki.push(Math.abs(_));var he=k-Sc;Sc=k,he>200&&(ki=[])},Wn:function(){var f=G(ki,10)>=G(ki,70);return!!ki.length&&f&&Dh},Fn:function(){return Nh}});function l0(){var f=U().css3?Ne()+E():y(V().N).item.offsetTop+y(V().N).item.offsetHeight,_=Wr(f);h.test.top=-f+"px",Y({canScroll:!1}),la(_.element,_.options,U().scrollingSpeed,function(){setTimeout(function(){Y({C:!0}),Y({canScroll:!0})},30)})}function c0(){Ke().getBoundingClientRect().bottom>=0&&Uh()}function Uh(){var f=Wr(y(V().N).item.offsetTop);Y({canScroll:!1}),la(f.element,f.options,U().scrollingSpeed,function(){Y({canScroll:!0}),Y({C:!1}),Y({Vn:!1})})}var yc,Mc,Ec,Oh=(yc=!1,Mc={},Ec={},function(f,_,M){switch(f){case"set":Mc[_]=new Date().getTime(),Ec[_]=M;break;case"isNewKeyframe":var P=new Date().getTime();yc=P-Mc[_]>Ec[_]}return yc});function po(){var f=V().P.next();f||!U().loopBottom&&!U().continuousVertical||(f=V().N[0]),f!=null?qr(f,null,!1):Ke().scrollHeight<Lt.scrollHeight&&U().scrollBar&&U().Zn&&J.L(bn)}function Yr(){var f=V().P.prev();f||!U().loopTop&&!U().continuousVertical||(f=y(V().N)),f!=null&&qr(f,null,!0)}h.moveSectionDown=po,h.moveSectionUp=Yr;var _a=0;function Fh(f){U().autoScrolling&&(T.canScroll&&(f.pageY<_a&&Kt().m.up?Yr():f.pageY>_a&&Kt().m.down&&po()),_a=f.pageY)}function Bh(f){if(Kt().m[f]){var _=f==="down"?po:Yr;Ft("scrollHorizontally")&&(_=Je("scrollHorizontally","getScrollSection",{type:f,scrollSection:_})),U().scrollOverflow&&et.mn(V().P)?et.Pn(f,V().P.item)&&et.Hn()&&_():_()}}var va,bc,Kr,xa=0,mo=0,Sa=0,go=0,ya=kh(),Ln={Bn:"ontouchmove"in window?"touchmove":ya?ya.move:null,Gn:"ontouchstart"in window?"touchstart":ya?ya.down:null};function _o(f){var _=z(f.target,qe)||V().P.item,M=et.mn(V().P);if(vo(f)){Y({X:!0,_:!1}),U().autoScrolling&&(M&&!T.canScroll||U().scrollBar)&&j(f);var P=Tc(f);Sa=P.y,go=P.x;var k=Math.abs(xa-Sa)>o.innerHeight/100*U().touchSensitivity,he=Math.abs(mo-go)>A()/100*U().touchSensitivity,re=p(Ht,_).length&&Math.abs(mo-go)>Math.abs(xa-Sa),Ve=xa>Sa?"down":"up";Y({Y:re?mo>go?"right":"left":Ve}),re?!T.W&&he&&(mo>go?Kt().m.right&&J.L(Xe,{section:_}):Kt().m.left&&J.L(je,{section:_})):U().autoScrolling&&T.canScroll&&k&&Bh(Ve)}}function vo(f){return f.pointerType===void 0||f.pointerType!="mouse"}function Ma(f){if(U().fitToSection&&Y({G:!1}),vo(f)){var _=Tc(f);xa=_.y,mo=_.x}Le("touchend",Hh)}function Hh(){S("touchend",Hh),Y({X:!1})}function Tc(f){var _={};return _.y=f.pageY!==void 0&&(f.pageY||f.pageX)?f.pageY:f.touches[0].pageY,_.x=f.pageX!==void 0&&(f.pageY||f.pageX)?f.pageX:f.touches[0].pageX,u&&vo(f)&&U().scrollBar&&f.touches!==void 0&&(_.y=f.touches[0].pageY,_.x=f.touches[0].pageX),_}function kh(){var f;return o.PointerEvent&&(f={down:"pointerdown",move:"pointermove"}),f}function Ac(f){U().autoScrolling&&vo(f)&&Kt().m.up&&(T.canScroll||j(f))}function zh(f,_){var M=_??V().P.item,P=Kl(T.N,M),k=p(Ht,M)[0];if(!(k==null||sa()||T.W||P.slides.length<2)){var he=P.activeSlide,re=f==="left"?he.prev():he.next();if(!re){if(!U().loopHorizontal)return;re=f==="left"?y(P.slides):P.slides[0]}Y({W:!h.test.hn}),dr(k,re.item,f)}}function wc(f){zh("left",f)}function Rc(f){zh("right",f)}function Cc(f){var _=V().N.filter(function(P){return P.anchor===f})[0];if(!_){var M=f!==void 0?f-1:0;_=V().N[M]}return _}function Vh(f){f!=null&&dr(z(f,Ht),f)}function Lc(f,_){var M=Cc(f);if(M!=null){var P=function(k,he){var re=he.slides.filter(function(Ve){return Ve.anchor===k})[0];return re==null&&(k=k!==void 0?k:0,re=he.slides[k]),re?re.item:null}(_,M);M.anchor&&M.anchor===T.Z||b(M.item,q)?Vh(P):qr(M,function(){Vh(P)})}}function xo(f,_){var M=Cc(f);_!==void 0?Lc(f,_):M!=null&&qr(M)}function u0(){clearTimeout(bc),Ie("keydown",Gh),Ie("keyup",Wh)}function Gh(f){clearTimeout(bc);var _=f.keyCode,M=[37,39].indexOf(_)>-1,P=U().autoScrolling||U().fitToSection||M;_===9?function(k){var he=k.shiftKey,re=a.activeElement,Ve=Pc(ur(V().P.item));function Oe(Wt){return j(Wt),Ve[0]?Ve[0].focus():null}if(T.canScroll){if(!function(Wt){var It=Pc(a),Dt=It.indexOf(a.activeElement),pt=It[Wt.shiftKey?Dt-1:Dt+1],Zt=z(pt,ot),tn=z(pt,qe);return!Zt&&!tn}(k)){re?z(re,".fp-section.active,.fp-section.active .fp-slide.active")==null&&(re=Oe(k)):Oe(k);var nt=re==Ve[0],dt=re==Ve[Ve.length-1],tt=he&&nt;if(tt||!he&&dt){j(k);var _t=function(Wt){var It,Dt=Wt?"prevPanel":"nextPanel",pt=[],Zt=oh((T.P&&T.P.activeSlide?T.P.activeSlide:T.P)[Dt]());do(pt=Pc(Zt.item)).length&&(It={Yn:Zt,Un:pt[Wt?pt.length-1:0]}),Zt=oh(Zt[Dt]());while(Zt&&pt.length===0);return It}(tt),Et=_t?_t.Yn:null;if(Et){var $t=Et.rn?Et:Et.parent;J.L(be,{Xn:$t.index()+1,slideAnchor:Et.rn?0:Et.index()}),Kr=_t.Un,j(k)}}}}else j(k)}(f):!me()&&U().keyboardScrolling&&P&&(va=f.ctrlKey,bc=setTimeout(function(){(function(k){var he=k.shiftKey,re=a.activeElement,Ve=W(re,"video")||W(re,"audio"),Oe=et.Pn("up",V().P.item),nt=et.Pn("down",V().P.item),dt=[37,39].indexOf(k.keyCode)>-1;if(function(tt){(function(_t){return[40,38,32,33,34].indexOf(_t.keyCode)>-1&&!T.C})(tt)&&!z(tt.target,Ct)&&tt.preventDefault()}(k),T.canScroll||dt)switch(Y({H:"keydown"}),k.keyCode){case 38:case 33:Kt().k.up&&Oe?T.C?J.L(We,{e:k}):Yr():et.Sn();break;case 32:if(he&&Kt().k.up&&!Ve&&Oe){Yr();break}case 40:case 34:if(Kt().k.down&&nt){if(T.C)return;k.keyCode===32&&Ve||po()}else et.Sn();break;case 36:Kt().k.up&&xo(1);break;case 35:Kt().k.down&&xo(V().N.length);break;case 37:Kt().k.left&&wc();break;case 39:Kt().k.right&&Rc()}})(f)},0))}function Wh(f){T.J&&(va=f.ctrlKey)}function f0(){Y({J:!1}),va=!1}function h0(f){Xh()}function d0(f){z(Kr,ot)&&!z(Kr,Tt)||Xh()}function Xh(){Kr&&(Kr.focus(),Kr=null)}function Pc(f){return[].slice.call(p('a[href], area[href], input:not([disabled]), select:not([disabled]), textarea:not([disabled]), button:not([disabled]), iframe, object, embed, [tabindex="0"], [contenteditable]',f)).filter(function(_){return ne(_,"tabindex")!=="-1"&&_.offsetParent!==null})}h.moveSlideLeft=wc,h.moveSlideRight=Rc,h.moveTo=xo,J.R(Ae,function(){Le("blur",f0),ge("keydown",Gh),ge("keyup",Wh),J.R(we,u0),J.R(Oi,h0),J.R(io,d0)});var jh=new Date().getTime(),$r=[];function Ic(f){f?(function(){var _,M="";o.addEventListener?_="addEventListener":(_="attachEvent",M="on");var P="onwheel"in a.createElement("div")?"wheel":a.onmousewheel!==void 0?"mousewheel":"DOMMouseScroll",k=Ih();P=="DOMMouseScroll"?a[_](M+"MozMousePixelScroll",Zr,k):a[_](M+P,Zr,k)}(),Ke().addEventListener("mousedown",qh),Ke().addEventListener("mouseup",Yh)):(a.addEventListener?(Ie("mousewheel",Zr,!1),Ie("wheel",Zr,!1),Ie("MozMousePixelScroll",Zr,!1)):a.detachEvent("onmousewheel",Zr),Ke().removeEventListener("mousedown",qh),Ke().removeEventListener("mouseup",Yh))}function Zr(f){var _=new Date().getTime(),M=b(p(".fp-completely")[0],"fp-normal-scroll"),P=function(dt,tt){new Date().getTime();var _t=V().C&&dt.getBoundingClientRect().bottom>=0&&ga.Fn()==="up",Et=V().Vn;if(Et)return j(tt),!1;if(V().C){if(_t){var $t;if(!(Et||Oh("isNewKeyframe","beyondFullpage")&&ga.Wn()))return($t=Wr(y(V().N).item.offsetTop+y(V().N).item.offsetHeight)).element.scrollTo(0,$t.options),Y({Vn:!1}),j(tt),!1;if(ga.Wn())return _t=!1,Y({Vn:!0}),Y({H:"wheel"}),Uh(),j(tt),!1}else Oh("set","beyondFullpage",1e3);if(!Et&&!_t)return!0}}(Ke(),f);if(T._||Y({X:!1,_:!0,Y:"none"}),!Kt().m.down&&!Kt().m.up)return j(f),!1;if(P)return!0;if(P===!1)return j(f),!1;if(U().autoScrolling&&!va&&!M){var k=(f=f||o.event).wheelDelta||-f.deltaY||-f.detail,he=Math.max(-1,Math.min(1,k)),re=f.wheelDeltaX!==void 0||f.deltaX!==void 0,Ve=Math.abs(f.wheelDeltaX)<Math.abs(f.wheelDelta)||Math.abs(f.deltaX)<Math.abs(f.deltaY)||!re,Oe=he<0?"down":he>0?"up":"none";$r.length>149&&$r.shift(),$r.push(Math.abs(k)),U().scrollBar&&j(f);var nt=_-jh;return jh=_,nt>200&&($r=[]),Y({U:Oe}),T.canScroll&&!sa()&&G($r,10)>=G($r,70)&&Ve&&(Y({H:"wheel"}),Bh(he<0?"down":"up")),!1}U().fitToSection&&Y({G:!1})}function qh(f){var _;f.which==2&&(_=f.pageY,_a=_,Ke().addEventListener("mousemove",Fh))}function Yh(f){f.which==2&&Ke().removeEventListener("mousemove",Fh)}function So(f){f?(Ic(!0),function(){if(Ln.Bn&&(l||u)&&(!Ft("dragAndMove")||U().dragAndMove==="mouseonly")){U().autoScrolling&&(Lt.removeEventListener(Ln.Bn,Ac,{passive:!1}),Lt.addEventListener(Ln.Bn,Ac,{passive:!1}));var _=U().touchWrapper;_.removeEventListener(Ln.Gn,Ma),_.removeEventListener(Ln.Bn,_o,{passive:!1}),_.addEventListener(Ln.Gn,Ma),_.addEventListener(Ln.Bn,_o,{passive:!1})}}()):(Ic(!1),function(){if(Ln.Bn&&(l||u)){U().autoScrolling&&(Lt.removeEventListener(Ln.Bn,_o,{passive:!1}),Lt.removeEventListener(Ln.Bn,Ac,{passive:!1}));var _=U().touchWrapper;_.removeEventListener(Ln.Gn,Ma),_.removeEventListener(Ln.Bn,_o,{passive:!1})}}())}h.setMouseWheelScrolling=Ic;var Dc=!0;function p0(){["mouseenter","touchstart","mouseleave","touchend"].forEach(function(f){Ie(f,$h,!0)})}function Kh(f,_){document["fp_"+f]=_,ge(f,$h,!0)}function $h(f){var _=f.type,M=!1,P=_==="mouseleave"?f.toElement||f.relatedTarget:f.target;P!=document&&P?(_==="touchend"&&(Dc=!1,setTimeout(function(){Dc=!0},800)),(_!=="mouseenter"||Dc)&&(U().normalScrollElements.split(",").forEach(function(k){if(!M){var he=W(P,k),re=z(P,k);(he||re)&&(h.shared._n||So(!1),h.shared._n=!0,M=!0)}}),!M&&h.shared._n&&(So(!0),h.shared._n=!1))):So(!0)}function Ea(f,_){ao(0,"internal"),xo(f,_),ao(Gr().scrollingSpeed,"internal")}J.R(Ae,function(){U().normalScrollElements&&(["mouseenter","touchstart"].forEach(function(f){Kh(f,!1)}),["mouseleave","touchend"].forEach(function(f){Kh(f,!0)})),J.R(we,p0)}),h.silentMoveTo=Ea;var Nc,Zh,Uc=E(),Jh=A(),Oc=!1;function m0(){clearTimeout(Nc),clearTimeout(Zh),S("resize",Fc)}function Fc(){Oc||(U().autoScrolling&&!U().scrollBar||!U().fitToSection)&&Qh(E()),function(){if(l)for(var f=0;f<4;f++)Zh=setTimeout(function(){window.requestAnimationFrame(function(){U().autoScrolling&&!U().scrollBar&&(Y({F:!0}),Ea(T.P.index()+1),Y({F:!1}))})},200*f)}(),Oc=!0,clearTimeout(Nc),Nc=setTimeout(function(){(function(){if(Y({F:!0}),Qh(""),O(Ke(),"onResize"),U().autoScrolling||T.C||function(){if(!U().autoScrolling||U().scrollBar){var k=.01*o.innerHeight;a.documentElement.style.setProperty("--vh","".concat(k,"px"))}}(),J.L(Ue),ei(),Eh(),l){var f=a.activeElement;if(!W(f,"textarea")&&!W(f,"input")&&!W(f,"select")){var _=E();Math.abs(_-Uc)>20*Math.max(Uc,_)/100&&(Bc(!0),Uc=_)}}else M=E(),P=A(),T.q===M&&Jh===P||(Y({q:M}),Jh=P,Bc(!0));var M,P;O(Ke(),"onResizeEnds"),Y({F:!1})})(),Oc=!1},400)}function Bc(f){if(!b(Ke(),$)){Y({F:!0,q:E(),Qn:A()});for(var _=V().N,M=0;M<_.length;++M){var P=_[M],k=p(Ht,P.item)[0],he=P.slides;Ft("offsetSections")&&C(P.item,{height:ql(P.item)}),he.length>1&&dr(k,P.activeSlide.item)}U().scrollOverflow&&et.bn();var re=V().P.index();T.C||!re||Ft("fadingEffect")||Ft("dropEffect")||Ft("waterEffect")||Ea(re+1),Y({F:!1}),I(U().afterResize)&&f&&U().afterResize.call(Ke(),o.innerWidth,o.innerHeight),I(U().afterReBuild)&&!f&&U().afterReBuild.call(Ke()),O(Ke(),"afterRebuild")}}function Qh(f){V().N.forEach(function(_){var M=f!==""||Ft("offsetSections")?ql(_.item):"";C(_.item,{height:M})})}function Hc(){var f,_,M=o.location.hash;if(M.length){var P=M.replace("#","").split("/"),k=M.indexOf("#/")>-1;f=k?"/"+P[1]:decodeURIComponent(P[0]);var he=k?P[2]:P[1];he&&he.length&&(_=decodeURIComponent(he))}return{section:f,sn:_}}function g0(){S("hashchange",ed)}function ed(){if(!T.V&&!U().lockAnchors){var f=Hc(),_=f.section,M=f.sn,P=T.Z===void 0,k=T.Z===void 0&&M===void 0&&!T.W;_&&_.length&&(_&&_!==T.Z&&!P||k&&!sa()||!T.W&&T.B!=M&&!sa())&&J.L(be,{Xn:_,slideAnchor:M})}}function _0(f){var _=f.target;z(_,U().menu+" [data-menuanchor]")&&v0.call(_,f)}function v0(f){Y({H:"menu"}),!p(U().menu)[0]||!U().lockAnchors&&U().anchors.length||(j(f),J.L($e,{anchor:ne(this,"data-menuanchor")}))}function x0(f){var _=f.target;_&&z(_,"#fp-nav a")?r0.call(_,f.e):W(_,".fp-tooltip")?i0.call(_):(W(_,Fi)||z(_,Fi)!=null)&&Q_.call(_,f.e)}h.reBuild=Bc,J.R(Ae,function(){Fc(),Le("resize",Fc),J.R(we,m0)}),h.setLockAnchors=function(f){U().lockAnchors=f},J.R(Ae,function(){Le("hashchange",ed),J.R(we,g0)}),J.R(Ae,function(){ge("wheel",ga.In,Ih()),J.R(bn,l0),J.R(We,c0)}),J.R(Ae,function(){J.R(ke,_0)}),J.R(Ae,function(){J.R(ke,x0)});var kc,zc,td=0;function ba(f){var _,M,P,k,he;if(O(Ke(),"onScroll"),!T.F&&V().P&&(y(V().N),!V().C&&!V().Vn&&(!U().autoScrolling||U().scrollBar||Ft("dragAndMove"))&&!th())){var re=Ft("dragAndMove")?Math.abs(Je("dragAndMove","getCurrentScroll")):Ne(),Ve=function(xn){var Pn=xn>td?"down":"up";return td=xn,Y({K:xn}),Pn}(re),Oe=0,nt=re+E()/2,dt=(Ft("dragAndMove")?Je("dragAndMove","getDocumentHeight"):Lt.scrollHeight-E())===re,tt=V().N;if(Y({scrollY:re}),dt)Oe=tt.length-1;else if(re)for(var _t=0;_t<tt.length;++_t)(z(tt[_t].item,qe)||tt[_t].item).offsetTop<=nt&&(Oe=_t);else Oe=0;if(P=Ve,k=V().P.item.offsetTop,he=k+E(),(P=="up"?he>=Ne()+E():k<=Ne())&&(b(V().P.item,ze)||(H(V().P.item,ze),Z(He(V().P.item),ze))),M=(_=tt[Oe]).item,!_.isActive){Y({V:!0});var Et,$t,Wt=V().P.item,It=V().P.index()+1,Dt=Zl(V().P,M),pt=_.anchor,Zt=_.index()+1,tn=_.activeSlide,gi={P:Wt,sectionIndex:Zt-1,anchorLink:pt,element:M,leavingSection:It,direction:Dt,items:{origin:V().P,destination:_}};tn&&($t=tn.anchor,Et=tn.index()),T.canScroll&&(Z(tt.filter(function(xn){return xn.index()!==_.index()}).map(function(xn){return xn.item}),q),H(M,q),Je("parallax","afterLoad"),I(U().beforeLeave)&&Sh("beforeLeave",gi),I(U().onLeave)&&Qn("onLeave",gi),I(U().afterLoad)&&Qn("afterLoad",gi),Je("resetSliders","apply",{localIsResizing:T.F,leavingSection:It}),ec(Wt),Xr(M),ca(M),sc(pt,Zt-1),U().anchors.length&&Y({Z:pt}),ei(),tc(Et,$t,pt)),clearTimeout(kc),kc=setTimeout(function(){Y({V:!1})},100)}U().fitToSection&&T.canScroll&&(clearTimeout(zc),zc=setTimeout(function(){T.N.filter(function(xn){var Pn=xn.item.getBoundingClientRect();return Math.round(Pn.bottom)===Math.round(E())||Math.round(Pn.top)===0}).length||Mh()},U().en))}}function nd(f,_){_!==void 0?(_=_.replace(/ /g,"").split(",")).forEach(function(M){fa(f,M,"k")}):(fa(f,"all","k"),U().keyboardScrolling=f)}function S0(f){var _=f.index();U().anchors[_]!==void 0&&f.isActive&&sc(U().anchors[_],_),U().menu&&U().css3&&z(p(U().menu)[0],pi)!=null&&p(U().menu).forEach(function(M){Lt.appendChild(M)})}function id(){var f,_,M=V().P,P=V().P.item;H(P,ze),Xr(P),vh(),ca(P),_=Cc((f=Hc()).section),f.section&&_&&(_===void 0||_.index()!==R(Th))||!I(U().afterLoad)||Qn("afterLoad",{P,element:P,direction:null,anchorLink:M.anchor,sectionIndex:M.index(),items:{origin:V().P,destination:V().P}}),I(U().afterRender)&&Qn("afterRender"),O(Ke(),"afterRender")}function Vc(f,_){_!==void 0?(_=_.replace(/ /g,"").split(",")).forEach(function(M){fa(f,M,"m")}):fa(f,"all","m"),O(Ke(),"setAllowScrolling",{value:f,Jn:_})}function rd(){var f=Hc(),_=f.section,M=f.sn;_?U().animateAnchor?Lc(_,M):Ea(_,M):J.L(Ge,null)}J.R(we,function(){clearTimeout(kc),clearTimeout(zc)}),J.R(Ae,function(){Le("scroll",ba),a.body.addEventListener("scroll",ba),J.R(be,function(f){Lc(f.Xn,f.slideAnchor)}),J.R($e,function(f){xo(f.anchor,void 0)}),J.R(Ce,function(f){(f.direction==="down"?po:Yr)()}),J.R(Ot,function(f){qr(f.destination)})}),J.R(we,function(){S("scroll",ba)}),h.getActiveSlide=function(){return Ql(V().P.activeSlide)},h.getScrollX=function(){return T.scrollX},J.R(Ae,function(){J.R(we,n0),J.R(Mt,function(f){dr(f.slides,f.destination)}),J.R(Xe,function(f){Rc(f.section)}),J.R(je,function(f){wc(f.section)})}),J.R(Ae,function(){var f=U().credits.position,_=["left","right"].indexOf(f)>-1?"".concat(f,": 0;"):"",M=`
